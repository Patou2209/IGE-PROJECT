...
/* ── Routage par rôle ─────────────────────────────────────────────────────
   CORRECTION : les dashboards sont dans  templates/  (pas dashboard/)
   index.html est à la racine → chemin relatif = "templates/xxx.html"
   ────────────────────────────────────────────────────────────────────── */
window.EKOLSTAT.routeByRole = function (role) {
  switch ((role || "").toLowerCase()) {
    case "ige":          return "templates/ige.html";
    case "ipp":          return "templates/ipp.html";
    case "sousdivision":
    case "sous-division":return "templates/sous-division.html";
    case "ecole":
    case "école":        return "templates/ecole.html";
